        ...
        <div class="col-lg">
          <form id="formBiodataPeserta" method="post" role="form" class="php-email-form">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="nama_peserta" placeholder="Nama Lengkap Peserta" value="<?= $cekTahapSatu['nama_peserta']; ?>" required />
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="nim" placeholder="Nomor Induk Mahasiswa" value="<?= $cekTahapSatu['nim']; ?>" required />
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="prodi" placeholder="Program Studi" value="<?= $cekTahapSatu['prodi']; ?>" required />
              <small id="prodi_error" class="form-text text-danger mb-3"></small>
            </div>

            <div class="form-group">
              <label for="judul">Judul Project<span style="color:red"> *</span></label>
              <input type="text" class="form-control" name="judul" placeholder="Judul Project Yang Ingin Diajukan" value="<?= $cekTahapSatu['judul']; ?>" required />
              <small id="judul_error" class="form-text text-danger mb-3"></small>
            </div>

            <div class="form-group">
              <label for="no_hp">No. Handphone<span style="color:red"> *</span></label>
              <input type="text" class="form-control" name="no_hp" placeholder="No. Handphone Anda" value="<?= $cekTahapSatu['no_hp']; ?>" required />
            ...
            <div class="form-group">
              ...
              <textarea class="form-control" name="alamat_peserta" rows="5" placeholder="Alamat Anda" required><?= $cekTahapSatu['alamat_peserta']; ?></textarea>
            ...
            <div class="form-group">
              ...
              <textarea name="keahlian" class="form-control" id="keahlian" cols="30" rows="5" placeholder="Keahlian Anda (Front End Web, Data Analyst, UI UX Designer,dll)" value="<?= $cekTahapSatu['keahlian']; ?>" required></textarea>
            ...
            <div class="form-group">
              ...
              <textarea name="tools" class="form-control" id="tools" cols="30" rows="5" placeholder="Tools Yang Anda Kuasai (Codeigniter, Laravel, Figma, dll)" value="<?= $cekTahapSatu['tools']; ?>" required></textarea>
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="status_permohonan" id="status_permohonan" required>
