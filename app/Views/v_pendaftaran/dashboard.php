        ...
        <div class="col-lg">
          ...
          <?php if ($tgl_sekarang >= $tgl_pengumuman) : ?>
            <div class="alert alert-info mt-4" role="alert">
              ...
              <hr>
              <p class="text-center">
                <span>Hari ini adalah hari pengumuman Anda.</span> Silahkan tunggu pengumuman administrasi Anda diterima atau tidak.
                Kami akan mengirimkan informasi tersebut melalui email yang terdaftar.
              </p>
            </div>
          <?php endif ?>
