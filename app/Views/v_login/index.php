            ...
            <form id="formLogin" role="form" class="php-email-form">
              ...
              <div class="form-group">
                <div class="input-group">
                  ...
                  <small id="g-recaptcha-response_error" class="form-text text-danger mb-3"></small>
                </div> 
              </div>
        ...
        $.ajax({
          ...
          success: function(data) {
            ...
            if (data.error) {
              ...
              if (data.login_error['g-recaptcha-response'] != '') $('#g-recaptcha-response_error').html(data.login_error['g-recaptcha-response']);
              else $('#g-recaptcha-response_error').html('');
            }
